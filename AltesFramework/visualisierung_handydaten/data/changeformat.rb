...
file = File.new(output_file, "w")
  ...
  arr.each { |p|
   #p.print_csv_record [2,8]
   	unless p.longitude.length==0 
   	#or not p.longitude.to_f.between?(13.100000, 13.800000) or p.latitude.length==0 or not p.latitude.to_f.between?(52.370000, 52.6600) or p.end_time.length==0
