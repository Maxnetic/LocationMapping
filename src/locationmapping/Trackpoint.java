...
class Trackpoint {
  ...
  */
  ...
  /**
  * Eigenschaft, die später festlegt, ob aus einem Trackpoint ein Marker erstellt werden soll
  */
  ...
  */
  ...
  /**
  * Gibt Identifikationsnummer des Trackpoints aus
  *
  ...
  */
  ...
  /**
  * Setzt die Visible-Eigenschaft des Trackpoints
  *
  * @param visible [Boolean]: verändert visible Eigenschaft
  */
  ...
  /**
  * Gibt die visible Eigenschaft eines Trackpoints aus
  *
  * @return [Boolean]: Gibt an, ob der Trackpoint momentan sichtbar ist
  */
  ...
  /**
  * Gibt Zeitstempel des Trackpoints aus
  *
  * @return [Timestamp]: Zeitstempel des Trackpoints
  */
  ...
  /**
  * Gibt das Jahr des Trackpoints aus
  *
  *@return [int]: Das Jahr des Trackpoints
  */
  public int getYear(){
  ...
  /**
  * Gibt den Monat des Trackpoints aus
  *
  * @return [int]: Der Monat des Trackpoints
  */
  public int getMonth(){
    Date dateTime = new Date(this.timestamp.getTime());
  ...
  /**
  * Gibt den Zeitstempel des Trackpoints in Sekunden aus
  *
  ...
  */
  ...
  /**
  * Gibt Datum und Uhrzeit des Trackpoints aus
  *
  ...
  */
  ...
  /**
  * Gibt Längengrad des Trackpoints aus
  *
  ...
  */
  ...
  /**
  * Gibt Breitengrad des Trackpoints aus
  *
  * @return [float] Breitengrad des Trackpoints
  */
  ...
  *
  * @param trackpoint/timestamp [Trackpoint/Timestamp]: Trackpoint/Timestamp mit dem Zeit verglichen wird
  * @return [int]: Zahl gleich 0 falls gleich, kleiner 0 falls anderer Trackpoint früher, größer 0 falls anderer Trackpoint später
  */
  ...
  *
  * @param trackpoint/location [Trackpoint/Location]: Trackpoint/Location zu dem der Abstand berechnet wird
